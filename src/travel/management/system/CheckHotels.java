...
JLabel caption;
public void run(){
    String text[]=new String[]{"Taj Mahal Palace Mumbai"," The Oberoi Udaivilas, Udaipur", "Leela Palace, New Delhi"," ITC Grand Chola, Chennai","The Ritz-Carlton, Bangalore"," Umaid Bhawan Palace, Jodhpur"," Taj Lake Palace, Udaipur"," The Leela Palace, Udaipur"," JW Marriott, Pune","Trident, Agra"};
